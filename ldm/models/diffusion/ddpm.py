...
class LatentDiffusionCogSR(DDPM):
    ...
    def __init__(self,
        ...
        if not scale_by_std:
            ...
            self.register_buffer('scale_factor', torch.tensor(scale_factor))
        self.instantiate_first_stage(first_stage_config)    # AuroencoderKL，用了stable diffusion 2.1中的编码器
        self.instantiate_cond_stage(cond_stage_config)
