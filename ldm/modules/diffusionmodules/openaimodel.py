...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(self, x, emb, context=None, lr=None, lr_prompt=None, struct_cond=None, 
                reference=None, gen_mode=False, seg_prompt_emb=None, seg_img_emb=None):
        for layer in self:
...
class UNetModelAiA(nn.Module):
    ...
    def forward(self, x, timesteps=None, condition=None, y=None, gen_mode=False,**kwargs):
        ...
        if not gen_mode:
            ...
            #     for name, module in block.named_children():  # 或者使用 .children() 遍历成员
            #         print(f"Member: {name}, Type: {type(module)}",end=' ')
            #     print('////',end='')
            # print('input_blocks done')
            # for name, module in self.middle_block.named_children():  # 或者使用 .children() 遍历成员
            #     print(f"Member: {name}, Type: {type(module)}",end=' ')
            # print('middle_blocks done')
